...
/*
 * decomp/src/netplay/menus/mnplayersvs_netmenu.c — netmenu fork of mn/mnplayers/mnplayersvs.c.
 * Offline classic CSS backs to nSCKindVSOfflineClassic (mnvsoffline); hub CSS backs to nSCKindVSMode.
