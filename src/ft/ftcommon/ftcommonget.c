...
void ftCommonLiftTurnUpdateModelYaw(FTStruct *fp)
{
    ...
    if (ftStatusVarsLift(fp)->turn_tics == (FTCOMMON_LIFT_TURN_FRAMES / 2))
    {
        fp->lr = -fp->lr;
...
void ftCommonLiftTurnProcUpdate(GObj *fighter_gobj)
{
    ...
    if (ftStatusVarsLift(fp)->turn_tics == 0)
    {
...
void ftCommonLiftTurnSetStatus(GObj *fighter_gobj)
{
    ...
    ftStatusVarsLift(fp)->turn_tics = FTCOMMON_LIFT_TURN_FRAMES;
