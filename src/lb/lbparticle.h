...
extern void lbParticleBeginVortexSoftFadeID(u16 generator_id);
extern sb32 lbParticleEjectVortexBottomRingID(u16 generator_id);
extern void lbParticleStepVortexSoftFadeID(u16 generator_id, s32 ticks_remaining, s32 ticks_total);
extern u16 lbParticleGetVortexRingCountID(u16 generator_id);
extern void lbParticleEjectGeneratorID(u16 generator_id);
